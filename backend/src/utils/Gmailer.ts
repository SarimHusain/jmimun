...
export default class Gmailer {
	...
	SingleDataDelivery(mail:IEmail, content:EmailContent, data:DataItem[]) {
	...
	DatasetDelivery(mail:IEmail, content:EmailContent, database:EmailDatabase) {

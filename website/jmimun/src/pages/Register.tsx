...
export default class Register extends Component {
    ...
    aboutYou = (
        <section>
            ...
            {this.state.committeeSize === 2 ? (<p style={{ "fontSize": "1.4em", "color":"#fff"}}>Delegate 1</p>) : (<div></div>)}
            <Textbox
                name="user/1#name"
                placeholder="Name"
                type="text"
            ...
            <Textbox
                ...
                validationErrorHelptext="This field is required"
            />
            <p style={{ "fontSize": "1.2em" }}>Type of Institution</p>
            <Radio
            ...
            {this.state.committeeSize === 2 ? (
                <div>
                    ...
                    <p style={{ "fontSize": "1.4em", "color": "#fff" }}>Delegate 2</p>
                    <Textbox
                        name="user/2#name"
                        placeholder="Name"
                        type="text"
    ...
    preferences = (
        <section>
            ...
            <p style={{ "fontSize": "1.2em", "color":"#fff"}}>Please enter your preferences</p>
            <p style={{"color":"#fff"}}>Preference 1</p>
            <Select
                name="pref1"
                onChange={(event: any) => { this.regInputHandler(event, this.state) }}
                options={this.state.matrix}
            />
            <p style={{"color":"#fff"}}>Preference 2</p>
            <Select
                name="pref2"
                onChange={(event: any) => { this.regInputHandler(event, this.state) }}
                options={this.state.matrix}
            />
            <p style={{"color":"#fff"}}>Preference 3</p>
            <Select
                name="pref3"
                onChange={(event: any) => { this.regInputHandler(event, this.state) }}
                options={this.state.matrix}
    ...
    payment = (
        <section>
            ...
            <p style={{ "fontSize": "1.2em", "color":"#fff"}}>Do you agree to the terms of payment?</p>
            <Radio
                name="payment"
                options={['Yes', 'No']}
                onChange={(event: any) => { this.regInputHandler(event, this.state) }}
            ...
            <div style={{ "textAlign": "center" }}>
                <Button color="primary" onClick={() => { this.changeSection() }}>Next</Button>
                (Change this to submit, somebody pls remind)
            </div>
        </section>
    )

    interface(page:number) {
        switch (page) {
            case 1:
        ...
        return (
            <div className="register">
                ...
                <div className="container">
                    {
                        this.interface(this.state.section)
                    }
                </div>
            </div>
        )
